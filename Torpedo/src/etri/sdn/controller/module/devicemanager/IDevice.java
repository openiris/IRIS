...
public interface IDevice {
    ...
    /**
     * Gets all unique VLAN IDs for the device. If the device has untagged 
    ...
    /**
     * Gets all unique attachment points associated with the device. This will
     ...
     *        but could be useful to show to a user
     * 
     * @return an array containing all unique attachment points for the device
     */
