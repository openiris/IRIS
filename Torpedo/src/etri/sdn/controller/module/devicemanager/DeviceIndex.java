...
public abstract class DeviceIndex {
    ...
    /**
     * Gets all device keys in the index. If certain devices exist multiple times, 
     * then these devices may be returned multiple times.
     * 
     * @return an iterator over device keys
     */
    ...
    /**
     * Adds a mapping from the given entity to the given device key. This update 
