...
public interface IEntityClassifierService extends IService {
    /**
    * Classifies the given entity into an IEntityClass.  It is important
    ...
    * returned by {@link #classifyEntity}.
    ...
    * {@link etri.sdn.controller.module.devicemanager.IEntityClass#getKeyFields()}.
    * 
    * @return a set containing the fields that should not be wildcarded.
    *         May be null to indicate that all fields are key fields.
    *         
    * @see etri.sdn.controller.module.devicemanager.IEntityClass#getKeyFields()
    * @see IEntityClassifierService#classifyEntity(Entity entity)
    */
   EnumSet<DeviceField> getKeyFields();

   /**
    * Reclassifies the given entity into a class.  When reclassifying entities,
    ...
    * @param newDevices all the new devices derived from the entities of the old device.
    *        If null, the old device was unchanged.
    */
