...
public class OFPortState {
	...
	public static int	STP_LISTEN	=	0;
	public static int	LINK_DOWN	=	1;
	public static int	STP_LEARN	=	0x100;
	public static int	STP_FORWARD	=	0x200;
	public static int	STP_BLOCK	=	0x300;
	public static int	STP_MASK	=	0x300;
	...
	static {
		mappings.put(org.openflow.protocol.interfaces.OFPortState.STP_LISTEN, STP_LISTEN);
		mappings.put(org.openflow.protocol.interfaces.OFPortState.LINK_DOWN, LINK_DOWN);
		mappings.put(org.openflow.protocol.interfaces.OFPortState.STP_LEARN, STP_LEARN);
		mappings.put(org.openflow.protocol.interfaces.OFPortState.STP_FORWARD, STP_FORWARD);
		mappings.put(org.openflow.protocol.interfaces.OFPortState.STP_BLOCK, STP_BLOCK);
		mappings.put(org.openflow.protocol.interfaces.OFPortState.STP_MASK, STP_MASK);
	}
