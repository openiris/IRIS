...
public class OFFlowModify extends OFFlowMod implements org.openflow.protocol.ver1_3.interfaces.OFFlowModify {
    ...
    public OFFlowModify() {
		...
		setCommand(OFFlowModCommand.valueOf((byte)1));
    }
