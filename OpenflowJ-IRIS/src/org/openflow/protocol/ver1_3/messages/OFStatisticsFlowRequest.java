...
public class OFStatisticsFlowRequest extends OFStatisticsRequest implements org.openflow.protocol.interfaces.OFStatisticsFlowRequest {
    ...
    public OFStatisticsFlowRequest() {
        super();
	...
	public OFStatisticsFlowRequest setTableId(byte table_id) {
	...
	public OFStatisticsFlowRequest setOutGroup(int out_group) {
	...
	public OFStatisticsFlowRequest setCookie(long cookie) {
		this.cookie = cookie;
		return this;
	}
	...
	public OFStatisticsFlowRequest setCookieMask(long cookie_mask) {
	...
	public OFStatisticsFlowRequest setMatch(org.openflow.protocol.interfaces.OFMatch match) {
    ...
    public String toString() {
        return super.toString() +  ":OFStatisticsFlowRequest-"+":table_id=" + U8.f(table_id) + 
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof OFStatisticsFlowRequest)) {
            return false;
        }
        OFStatisticsFlowRequest other = (OFStatisticsFlowRequest) obj;
