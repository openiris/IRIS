...
public class OFQueuePropertyMinRate extends OFQueueProperty implements org.openflow.protocol.ver1_3.interfaces.OFQueuePropertyMinRate {
    ...
    public OFQueuePropertyMinRate() {
		...
		setType(OFQueuePropertyType.valueOf((short)1));
    }
