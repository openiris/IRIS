...
public class OFStatisticsTableFeaturesReply extends OFStatisticsReply implements org.openflow.protocol.interfaces.OFStatisticsTableFeaturesReply {
    public static int MINIMUM_LENGTH = 16;

    List<org.openflow.protocol.interfaces.OFTableFeatures>  entries;

    public OFStatisticsTableFeaturesReply() {
        super();
    ...
    public OFStatisticsTableFeaturesReply(OFStatisticsTableFeaturesReply other) {
    	super(other);
	...
	public OFStatisticsTableFeaturesReply setEntries(List<org.openflow.protocol.interfaces.OFTableFeatures> entries) {
    ...
    public String toString() {
        return super.toString() +  ":OFStatisticsTableFeaturesReply-"+":entries=" + entries.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof OFStatisticsTableFeaturesReply)) {
            return false;
        }
        OFStatisticsTableFeaturesReply other = (OFStatisticsTableFeaturesReply) obj;
