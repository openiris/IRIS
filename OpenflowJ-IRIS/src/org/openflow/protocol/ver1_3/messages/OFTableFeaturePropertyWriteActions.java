...
public class OFTableFeaturePropertyWriteActions extends OFTableFeatureProperty implements org.openflow.protocol.interfaces.OFTableFeaturePropertyWriteActions {
	...
	public OFTableFeaturePropertyWriteActions setActionIds(List<org.openflow.protocol.interfaces.OFActionId> action_ids) {
    ...
    public String toString() {
        return super.toString() +  ":OFTableFeaturePropertyWriteActions-"+":action_ids=" + action_ids;
    }
