...
public class OFTableFeaturePropertyWriteSetfield extends OFTableFeatureProperty implements org.openflow.protocol.interfaces.OFTableFeaturePropertyWriteSetfield {
    public static int MINIMUM_LENGTH = 4;
    public static int CORE_LENGTH = 0;

    List<Integer>  oxm_ids;

    public OFTableFeaturePropertyWriteSetfield() {
        super();
		setLength(U16.t(MINIMUM_LENGTH));
		setType(OFTableFeaturePropertyType.valueOf((short)12));
    }
	...
	public OFTableFeaturePropertyWriteSetfield setOxmIds(List<Integer> oxm_ids) {
	...
	public OFTableFeaturePropertyWriteSetfield dup() {
		return new OFTableFeaturePropertyWriteSetfield(this);
	}
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof OFTableFeaturePropertyWriteSetfield)) {
            return false;
        }
        OFTableFeaturePropertyWriteSetfield other = (OFTableFeaturePropertyWriteSetfield) obj;
