...
public class OFMultipartGroupReply extends OFMultipartReply implements org.openflow.protocol.interfaces.OFMultipartGroupReply {
    ...
    public OFMultipartGroupReply() {
		...
		this.entries = new LinkedList<org.openflow.protocol.interfaces.OFGroupStatsEntry>();
    }
    ...
    public OFMultipartGroupReply(OFMultipartGroupReply other) {
		...
		for ( org.openflow.protocol.interfaces.OFGroupStatsEntry i : other.entries ) { this.entries.add( new OFGroupStatsEntry((OFGroupStatsEntry)i) ); }
    }
	...
	public OFMultipartGroupReply setEntries(List<org.openflow.protocol.interfaces.OFGroupStatsEntry> entries) {
    ...
    public short computeLength() {
    	...
    	for ( org.openflow.protocol.interfaces.OFGroupStatsEntry i : this.entries ) { len += i.computeLength(); }
    	return len;
    }
