...
public class OFTableFeaturePropertyApplySetfieldMiss extends OFTableFeatureProperty  {
    public static int MINIMUM_LENGTH = 4;

    List<Integer>  oxm_ids;

    public OFTableFeaturePropertyApplySetfieldMiss() {
        super();
		setLength(U16.t(MINIMUM_LENGTH));
		setType(OFTableFeaturePropertyType.valueOf((short)15));
		this.oxm_ids = new LinkedList<Integer>();
    }
    
    public OFTableFeaturePropertyApplySetfieldMiss(OFTableFeaturePropertyApplySetfieldMiss other) {
    	super(other);
	...
	public OFTableFeaturePropertyApplySetfieldMiss setOxmIds(List<Integer> oxm_ids) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof OFTableFeaturePropertyApplySetfieldMiss)) {
            return false;
        }
        OFTableFeaturePropertyApplySetfieldMiss other = (OFTableFeaturePropertyApplySetfieldMiss) obj;
