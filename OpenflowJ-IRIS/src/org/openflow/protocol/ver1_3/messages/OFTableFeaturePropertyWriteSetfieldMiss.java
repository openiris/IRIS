...
public class OFTableFeaturePropertyWriteSetfieldMiss extends OFTableFeatureProperty  {
    ...
    public String toString() {
        return super.toString() +  ":OFTableFeaturePropertyWriteSetfieldMiss-"+":oxm_ids=" + oxm_ids.toString();
    }
