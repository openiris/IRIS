...
public class OFActionPushMpls extends OFAction implements org.openflow.protocol.ver1_3.interfaces.OFActionPushMpls {
    ...
    public OFActionPushMpls() {
		...
		setType(OFActionType.valueOf((short)19));
    }
    
    public OFActionPushMpls(OFActionPushMpls other) {
    	super(other);
    ...
    public String toString() {
        return super.toString() +  ":OFActionPushMpls-"+":ethertype=" + U16.f(ethertype);
    }
