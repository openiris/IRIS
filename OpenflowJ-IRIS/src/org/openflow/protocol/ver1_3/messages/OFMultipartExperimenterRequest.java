...
public class OFMultipartExperimenterRequest extends OFMultipartRequest  {
    ...
    public OFMultipartExperimenterRequest() {
        super();
    ...
    public OFMultipartExperimenterRequest(OFMultipartExperimenterRequest other) {
    	super(other);
	...
	public OFMultipartExperimenterRequest setExperimenterId(int experimenter_id) {
	...
	public OFMultipartExperimenterRequest setExperimentType(int experiment_type) {
    ...
    public String toString() {
        return super.toString() +  ":OFMultipartExperimenterRequest-"+":experimenter_id=" + U32.f(experimenter_id) + 
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof OFMultipartExperimenterRequest)) {
            return false;
        }
        OFMultipartExperimenterRequest other = (OFMultipartExperimenterRequest) obj;
