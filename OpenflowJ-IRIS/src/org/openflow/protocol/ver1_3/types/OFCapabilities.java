...
public class OFCapabilities {
	...
	public static int	GROUP_STATS	=	0x8;
	public static int	IP_REASM	=	0x20;
	public static int	QUEUE_STATS	=	0x40;
	public static int	PORT_BLOCKED	=	0x100;
	...
	static {
		...
		mappings.put(org.openflow.protocol.interfaces.OFCapabilities.GROUP_STATS, GROUP_STATS);
		...
		mappings.put(org.openflow.protocol.interfaces.OFCapabilities.PORT_BLOCKED, PORT_BLOCKED);
	}
