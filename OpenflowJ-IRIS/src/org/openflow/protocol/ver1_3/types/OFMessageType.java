...
public enum OFMessageType {
	...
	EXPERIMENTER	(4, org.openflow.protocol.interfaces.OFMessageType.EXPERIMENTER, 
	OFExperimenter.class, 
	new Instantiable<OFMessage>() {
    	public OFMessage instantiate() {
	...
	GROUP_MOD	(15, org.openflow.protocol.interfaces.OFMessageType.GROUP_MOD, 
	OFGroupMod.class, 
	new Instantiable<OFMessage>() {
    	public OFMessage instantiate() {
	...
	PORT_MOD	(16, org.openflow.protocol.interfaces.OFMessageType.PORT_MOD, 
	OFPortMod.class, 
	new Instantiable<OFMessage>() {
    	public OFMessage instantiate() {
	...
	TABLE_MOD	(17, org.openflow.protocol.interfaces.OFMessageType.TABLE_MOD, 
	OFTableMod.class, 
	new Instantiable<OFMessage>() {
    	public OFMessage instantiate() {
	...
	BARRIER_REPLY	(21, org.openflow.protocol.interfaces.OFMessageType.BARRIER_REPLY, 
	...
	QUEUE_GET_CONFIG_REQUEST	(22, org.openflow.protocol.interfaces.OFMessageType.QUEUE_GET_CONFIG_REQUEST, 
	...
	QUEUE_GET_CONFIG_REPLY	(23, org.openflow.protocol.interfaces.OFMessageType.QUEUE_GET_CONFIG_REPLY, 
	...
	ROLE_REQUEST	(24, org.openflow.protocol.interfaces.OFMessageType.ROLE_REQUEST, 
	OFRoleRequest.class, 
	new Instantiable<OFMessage>() {
    	public OFMessage instantiate() {
	...
	ROLE_REPLY	(25, org.openflow.protocol.interfaces.OFMessageType.ROLE_REPLY, 
	OFRoleReply.class, 
	new Instantiable<OFMessage>() {
    	public OFMessage instantiate() {
	...
	GET_ASYNC_REQUEST	(26, org.openflow.protocol.interfaces.OFMessageType.GET_ASYNC_REQUEST, 
	OFGetAsyncRequest.class, 
	new Instantiable<OFMessage>() {
    	public OFMessage instantiate() {
      		return new OFGetAsyncRequest();
    	}
    }),
	GET_ASYNC_REPLY	(27, org.openflow.protocol.interfaces.OFMessageType.GET_ASYNC_REPLY, 
	OFGetAsyncReply.class, 
	new Instantiable<OFMessage>() {
    	public OFMessage instantiate() {
      		return new OFGetAsyncReply();
    	}
    }),
	SET_ASYNC	(28, org.openflow.protocol.interfaces.OFMessageType.SET_ASYNC, 
	OFSetAsync.class, 
	new Instantiable<OFMessage>() {
    	public OFMessage instantiate() {
	...
	METER_MOD	(29, org.openflow.protocol.interfaces.OFMessageType.METER_MOD, 
	OFMeterMod.class, 
	new Instantiable<OFMessage>() {
    	public OFMessage instantiate() {
