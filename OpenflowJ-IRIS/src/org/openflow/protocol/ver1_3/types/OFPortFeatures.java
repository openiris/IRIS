...
public class OFPortFeatures {
	...
	public static int	N_40GB_FD	=	0x80;
	public static int	N_100GB_FD	=	0x100;
	public static int	N_1TB_FD	=	0x200;
	public static int	OTHER	=	0x400;
	public static int	COPPER	=	0x800;
	public static int	FIBER	=	0x1000;
	public static int	AUTONEG	=	0x2000;
	public static int	PAUSE	=	0x4000;
	public static int	PAUSE_ASYM	=	0x8000;
	...
	static {
		...
		mappings.put(org.openflow.protocol.interfaces.OFPortFeatures.N_40GB_FD, N_40GB_FD);
		mappings.put(org.openflow.protocol.interfaces.OFPortFeatures.N_100GB_FD, N_100GB_FD);
		mappings.put(org.openflow.protocol.interfaces.OFPortFeatures.N_1TB_FD, N_1TB_FD);
		mappings.put(org.openflow.protocol.interfaces.OFPortFeatures.OTHER, OTHER);
