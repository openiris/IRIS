...
public enum OFPortModFailedCode {
	...
	BAD_CONFIG(2, org.openflow.protocol.interfaces.OFPortModFailedCode.BAD_CONFIG),
	BAD_ADVERTISE(3, org.openflow.protocol.interfaces.OFPortModFailedCode.BAD_ADVERTISE),
	EPERM(4, org.openflow.protocol.interfaces.OFPortModFailedCode.EPERM);
