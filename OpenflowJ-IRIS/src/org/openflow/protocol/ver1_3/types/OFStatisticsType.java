...
public enum OFStatisticsType {
    DESC	(0, org.openflow.protocol.interfaces.OFStatisticsType.DESC,
  	...
  	GROUP	(6, org.openflow.protocol.interfaces.OFStatisticsType.GROUP,
  		OFStatisticsGroupRequest.class, OFStatisticsGroupReply.class,
	    new Instantiable<OFStatistics>() {
	      public OFStatistics instantiate() {
	        return new OFStatisticsGroupRequest();
	      }
	    },
	    new Instantiable<OFStatistics>() {
	      public OFStatistics instantiate() {
	        return new OFStatisticsGroupReply();
	      }
    	}),
  	GROUP_DESC	(7, org.openflow.protocol.interfaces.OFStatisticsType.GROUP_DESC,
  		OFStatisticsGroupDescRequest.class, OFStatisticsGroupDescReply.class,
	    new Instantiable<OFStatistics>() {
	      public OFStatistics instantiate() {
	        return new OFStatisticsGroupDescRequest();
	      }
	    },
	    new Instantiable<OFStatistics>() {
	      public OFStatistics instantiate() {
	        return new OFStatisticsGroupDescReply();
	      }
    	}),
  	GROUP_FEATURES	(8, org.openflow.protocol.interfaces.OFStatisticsType.GROUP_FEATURES,
  		OFStatisticsGroupFeaturesRequest.class, OFStatisticsGroupFeaturesReply.class,
	    new Instantiable<OFStatistics>() {
	      public OFStatistics instantiate() {
	        return new OFStatisticsGroupFeaturesRequest();
	      }
	    },
	    new Instantiable<OFStatistics>() {
	      public OFStatistics instantiate() {
	        return new OFStatisticsGroupFeaturesReply();
	      }
    	}),
  	METER	(9, org.openflow.protocol.interfaces.OFStatisticsType.METER,
  		OFStatisticsMeterRequest.class, OFStatisticsMeterReply.class,
	    new Instantiable<OFStatistics>() {
	      public OFStatistics instantiate() {
	        return new OFStatisticsMeterRequest();
	      }
	    },
	    new Instantiable<OFStatistics>() {
	      public OFStatistics instantiate() {
	        return new OFStatisticsMeterReply();
	      }
    	}),
  	METER_CONFIG	(10, org.openflow.protocol.interfaces.OFStatisticsType.METER_CONFIG,
  		OFStatisticsMeterConfigRequest.class, OFStatisticsMeterConfigReply.class,
	    new Instantiable<OFStatistics>() {
	      public OFStatistics instantiate() {
	        return new OFStatisticsMeterConfigRequest();
	      }
	    },
	    new Instantiable<OFStatistics>() {
	      public OFStatistics instantiate() {
	        return new OFStatisticsMeterConfigReply();
	      }
    	}),
  	METER_FEATURES	(11, org.openflow.protocol.interfaces.OFStatisticsType.METER_FEATURES,
  		OFStatisticsMeterFeaturesRequest.class, OFStatisticsMeterFeaturesReply.class,
	    new Instantiable<OFStatistics>() {
	      public OFStatistics instantiate() {
	        return new OFStatisticsMeterFeaturesRequest();
	      }
	    },
	    new Instantiable<OFStatistics>() {
	      public OFStatistics instantiate() {
	        return new OFStatisticsMeterFeaturesReply();
	      }
    	}),
  	TABLE_FEATURES	(12, org.openflow.protocol.interfaces.OFStatisticsType.TABLE_FEATURES,
  		OFStatisticsTableFeaturesRequest.class, OFStatisticsTableFeaturesReply.class,
	    new Instantiable<OFStatistics>() {
	      public OFStatistics instantiate() {
	        return new OFStatisticsTableFeaturesRequest();
	      }
	    },
	    new Instantiable<OFStatistics>() {
	      public OFStatistics instantiate() {
	        return new OFStatisticsTableFeaturesReply();
	      }
    	}),
  	PORT_DESC	(13, org.openflow.protocol.interfaces.OFStatisticsType.PORT_DESC,
  		OFStatisticsPortDescRequest.class, OFStatisticsPortDescReply.class,
	    new Instantiable<OFStatistics>() {
	      public OFStatistics instantiate() {
	        return new OFStatisticsPortDescRequest();
	      }
	    },
	    new Instantiable<OFStatistics>() {
	      public OFStatistics instantiate() {
	        return new OFStatisticsPortDescReply();
	      }
    	}),
  	EXPERIMENTER	(0xffff, org.openflow.protocol.interfaces.OFStatisticsType.EXPERIMENTER,
  		OFStatisticsExperimenterRequest.class, OFStatisticsExperimenterReply.class,
	    new Instantiable<OFStatistics>() {
	      public OFStatistics instantiate() {
	        return new OFStatisticsExperimenterRequest();
	      }
	    },
	    new Instantiable<OFStatistics>() {
	      public OFStatistics instantiate() {
	        return new OFStatisticsExperimenterReply();
	      }
    	});
